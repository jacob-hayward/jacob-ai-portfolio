...
- A **resume agent** — ask it anything about me (proeffsioanlly with limited prsonal info)
...
The showcase agent took the longest to figure out. I went through maybe 30+ ideas across several sessions — everything from a "tea regional guide" (put in the tea traits you like and it will find one and send you a secure cart link), to a full relocation concierge for people moving to Melbourne or Berlin. What I landed on is a **Visa Information Agent** covering EU and Oceania. It won out for a few reasons: it's personally relevant to me if I decide to think beyond NZ, it solves a real problem people actually have, the data complexity gives it enough technical meat to be interesting, and it tells a coherent story to anyone reading the portfolio. 
